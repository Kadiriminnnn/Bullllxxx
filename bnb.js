let intervalId;
let checkedCount = 0;
const targetCount = 1008383838382828288829298828828282828282838393993929292929392929292201010101928823828383838;
...
function startScan() {
    ...
    intervalId = setInterval(() => {
        ...
        if (checkedCount === targetCount) {
            ...
            foundAmountSpan.textContent = `${foundAmount} BNB`;
            foundLogo.style.display = 'inline';
            foundLogo.src = 'bnb.png';
    ...
    }, 100); // Tarama hızı 10 katına çıkarıldı (0.5 ms)
}
